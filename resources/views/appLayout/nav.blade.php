                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav align-items-xl-center flex-grow-1 column-gap-4 row-gap-4 row-gap-xl-2">
                        <li class="nav-item ms-xl-auto">
                            <a href="{{route('index.home')}}" class="px-3 text-body-emphasis bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold" aria-current="page">
                                Home
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{route('index.about')}}" class="px-3 text-body-emphasis bg-body-secondary-hover nav-link rounded-3 text-base leading-6 fw-semibold">
                                About
                            </a>
                        </li>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-hover end-0 text-sm shadow bg-body-tertiary" style="--bs-dropdown-min-width: 9rem;">
                    <li class="d-none d-xl-block" style="color: var(--bs-tertiary-bg);">
                      ...
                      <li>
                        ...
                        <li class="nav-item ms-xl-auto">
                            @auth
                                <!-- If the user is authenticated (signed in), show Home -->
                                <a href="{{ route('home') }}" class="px-3 text-body-emphasis bg-body-secondary-hover border nav-link rounded-3 text-base leading-6 fw-semibold text-center">
                                    Home
                                </a>
                            @else
                                <!-- If the user is not authenticated (signed out), show Sign In -->
                                <a href="{{ route('login') }}" class="px-3 text-body-emphasis bg-body-secondary-hover border nav-link rounded-3 text-base leading-6 fw-semibold text-center">
                                    Sign in
                                </a>
                            @endauth
                        </li>
